...
import com.delivery.paymentservice.dto.PaymentErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<PaymentErrorResponse> handleResourceNotFound(ResourceNotFoundException ex) {
